...
export function SupportedProjects() {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-dark font-heading mb-6">Social Projects Supported</h2>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-6 bg-white rounded-lg shadow-sm">
          ...
          <p className="text-neutral">You haven't supported any projects yet.</p>
          <Link href="/projects">
            ...
            <Card key={project.id} className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <CardContent className="p-4">
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Link href={`/projects/${project.slug || project.id}`} className="text-primary hover:underline text-sm font-medium flex items-center">
                    View
