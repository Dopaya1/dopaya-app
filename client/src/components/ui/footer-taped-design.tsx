...
export function FooterTapedDesign() {
  ...
  return (
    <footer className="w-full py-20" style={{ backgroundColor: BRAND_COLORS.bgCool }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
            <input
              ...
              style={{ 
                ...
                focusRingColor: BRAND_COLORS.primaryOrange
              }}
              required
            />
            <button
              type="submit"
              className="px-6 py-2 rounded-lg text-white text-sm font-medium hover:opacity-90 transition-opacity flex items-center gap-2"
        ...
        {/* Main Footer - Taped Box with White Background */}
        <div 
          className="relative rounded-3xl px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-8"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-2 md:px-8 flex-1">
          ...
          <div className='flex flex-col items-start gap-3'>
            ...
            <div className="flex gap-4 items-center mt-1">
              <a
                ...
                aria-label="Dopaya Instagram"
                className="hover:opacity-70 transition-opacity"
              >
                <Instagram className="w-5 h-5" style={{ color: BRAND_COLORS.textSecondary }} />
              </a>
              <a
                href="https://facebook.com/dopayasocial"
                target="_blank"
                rel="nofollow noopener"
                aria-label="Dopaya Facebook"
                className="hover:opacity-70 transition-opacity"
              >
                <Facebook className="w-5 h-5" style={{ color: BRAND_COLORS.textSecondary }} />
              </a>
            </div>
          </div>
