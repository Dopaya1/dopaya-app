          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-1 flex flex-col justify-center">
              ...
              <div className="mb-4 px-4 py-2 bg-blue-50 border border-blue-200 rounded-lg inline-block">
                <span className="text-sm font-medium text-blue-800">🚀 Launching November 2025 • Platform Preview Available</span>
              </div>
              ...
              <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg max-w-md">
                <div className="text-sm font-semibold text-green-800 mb-1">Value Guarantee</div>
                <div className="text-green-700">
                  <span className="font-bold">$100 Support</span> = <span className="font-bold">1,000 Impact Points</span> = <span className="font-bold text-green-800">$150+ in Rewards</span>
                </div>
                <div className="text-xs text-green-600 mt-1">*Plus verified impact stories and exclusive experiences</div>
              </div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row">
                ...
                <Link href="/rewards" className="w-full sm:w-auto">
                  <Button variant="outline" size="lg" className="w-full mb-3 sm:mb-0 sm:mr-3 sm:w-auto">
                    Preview Rewards
                  </Button>
                </Link>

                <a href="https://tally.so/r/m6MqAe" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                  <Button variant="ghost" size="lg" className="w-full sm:w-auto text-neutral">
                    Join Waitlist
                  </Button>
                </a>
              </div>
