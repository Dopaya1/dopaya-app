...
const post: BlogPost = {
  ...
  tags: ["clean water", "social entrepreneurship", "micro-entrepreneurship", "water filter", "SDG 6"],
  primaryKeyword: "clean water",
  guestName: "Olivier Groninger",
  organizationName: "Openversum",
  episode: 1,
  publishedAt: "2026-03-19",
  content: `**Olivier Groninger** | Openversum | Impact Bites Episode 1
...
> **Read more about Openversum and support their mission on Dopaya**
> [https://dopaya.com/project/openversum](https://dopaya.com/project/openversum)
...
[Explore more social enterprises on Dopaya](https://dopaya.com)`,
  ...
  contentDe: `**Olivier Groninger** | Openversum | Impact Bites Episode 1

---

Mehr Menschen haben keinen Zugang zu sauberem Wasser als zum Internet – dabei existiert die Technologie, um das zu ändern, seit Jahren. Die globale Trinkwasserkrise ist kein wissenschaftliches Problem. Sie ist ein Systemproblem. Olivier Groninger, CEO und Mitgründer von [Openversum](https://openversum.com), hat das aus erster Hand erfahren, als er mit einem Stück Membran und einer Frage im ländlichen Kolumbien ankam: Warum hat noch niemand die Brücke gebaut?

[Ganze Episode auf YouTube ansehen](https://youtu.be/k6j-C3aod8A)

---

## Die wichtigsten Erkenntnisse

- Die Trinkwasserkrise betrifft bis zu 4 Milliarden Menschen – nicht weil es keine Lösungen gibt, sondern weil niemand ein tragfähiges System aufgebaut hat, um diese in grossem Massstab bereitzustellen und zu erhalten.
- Filter, die ohne Begleitung gespendet werden, landen als Blumentöpfe. Lokale Mikro-Unternehmer mit echten Anreizen übertreffen klassische NGO-Verteilung jedes Mal.
...
Was Olivier auszeichnet, sind nicht seine technischen Referenzen – es ist die Art und Weise, wie Felderfahrungen sein Denken geprägt haben. Er hat gesehen, wie gespendete Filter als Blumentöpfe zweckentfremdet wurden. Er wurde in Häuser eingeladen, in denen fast nichts vorhanden war, und bekam die letzten Kokosnüsse angeboten. Diese Begegnungen haben nicht nur die Dringlichkeit der Mission bestätigt. Sie haben grundlegend verändert, wie er über deren Lösung nachdenkt.

---

## Die Trinkwasserkrise: 4 Milliarden Menschen warten noch immer

2,2 Milliarden Menschen haben derzeit keinen Zugang zu sicher verwaltetem Trinkwasser. Erweitert man die Definition um jene, die theoretisch Zugang haben, ihn sich aber nicht leisten können, steigt diese Zahl auf 4 Milliarden. Für die Familien, die diese Realität leben, sind die Folgen nicht abstrakt: Sie werden krank, verbringen täglich Stunden damit, Wasser zu holen, oder geben einen unverhältnismässig grossen Teil ihres Einkommens aus, nur um zu überleben. Die versteckten Kosten – Arztkosten, verlorene Zeit, Holz zum Abkochen von verunreinigtem Wasser, täglich gekaufte Plastikbeutel – summieren sich zu weit mehr, als es kosten würde, das Problem zu lösen. Wie Olivier es schlicht formuliert: Es wäre tatsächlich günstiger, in sauberes Wasser zu investieren, als weiterhin den Preis dafür zu bezahlen, es nicht zu haben.

## Vom Doktorlabor ins ländliche Kolumbien: Wie Openversum entstand

Während seiner Doktorarbeit an der ETH Zürich erhielt Olivier Zugang zu einer Membrantechnologie, die Wasser ohne Strom aufbereiten kann. Anstatt sie rein im Labor weiterzuentwickeln, wollte er testen, ob sie in der Praxis wirklich funktioniert. 2019 reiste er ins ländliche Kolumbien – mit einem rohen Stück Membran im Gepäck, ohne fertiges Produkt, ohne Vertriebsplan, nur mit einem Material und einer Frage. Was er vorfand, bestätigte sowohl das Potenzial als auch die Lücke. Die Technologie konnte funktionieren. Aber niemand hatte die Systeme aufgebaut, damit sie für die betroffenen Gemeinschaften nachhaltig funktioniert. Aus dieser Lücke entstand Openversum.

## Warum gespendete Filter als Blumentöpfe enden

Im Trinkwassersektor wurde lange angenommen, das Problem sei die Technologie. Das ist es nicht. Olivier erkannte das deutlich auf dieser ersten Feldreise, wo gespendete Filter in den Gemeinschaften kein Wasser mehr filtrierten – sondern Pflanzen hielten. Das Produkt war angekommen, das Unterstützungssystem aber nicht. Ohne lokale Wartung, ohne Verantwortlichkeit, ohne jemanden, der ein Interesse daran hatte, den Filter am Laufen zu halten, wurde die Lösung zur Dekoration. Wie Olivier sagt: «Ich habe Filter gesehen, die als Blumentöpfe verwendet wurden. Filter herzustellen ist eigentlich einfach – alle Technologien existieren –, aber dann ist es sehr schwer, einen kontinuierlichen Betrieb sicherzustellen.» Spendenbasierte Modelle können Produkte zu Familien bringen, aber sie können sie nicht am Laufen halten. Das erfordert etwas Dauerhafteres: eine lokale Wirtschaft, die auf den Zugang zu sauberem Wasser ausgerichtet ist.

## Wie Openversum funktioniert: Lokale Unternehmer statt Hilfspakete

Openversum kombiniert einen kostengünstigen, stromlosen dreischichtigen Filter – der Bakterien, Schwermetalle und Pestizide entfernen kann – mit einer digitalen Plattform, die lokale Mikro-Unternehmer, vorwiegend Frauen, dabei unterstützt, nachhaltige Kleinunternehmen zu führen. Diese Wasserberater verkaufen und warten den Zugang zu sauberem Wasser von Tür zu Tür in ihren eigenen Gemeinschaften. Sie sind keine Hilfsempfänger. Sie sind Geschäftsinhaber mit Einkommen, mit Verantwortung und einem echten Grund, jeden Filter am Laufen zu halten. Die digitale Plattform macht sie bankfähig – sie erhalten Zugang zu der Mikrofinanzierung, die sie zum Wachsen brauchen – und genau das ermöglicht es dem Modell, über einen Pilotversuch hinaus zu wachsen und etwas Dauerhaftes zu werden.
...
## Oliviers Botschaft an die Welt

> «Es gibt viele grossartige Technologien, die bereits existieren – aber jetzt geht es wirklich darum, wie man diese Technologien nachhaltig zu den Menschen bringt, nachhaltig im langfristigen Sinne. Sozialunternehmen, die das lokal tun, werden noch immer ziemlich übersehen. Wenn du ihnen begegnest, unterstütze sie – sag nicht einfach ‹gut gemacht›, sondern erschliess die Finanzierung und unterstütze sie.»

Olivier bittet nicht um Applaus. Er bittet um die Art von greifbarer Unterstützung – finanziell, strukturell und beziehungsmässig –, die aus einem vielversprechenden Modell ein dauerhaftes macht. Die Technologie existiert. Die Unternehmer existieren. Was lokale Sozialunternehmen wie Openversum jetzt brauchen, ist die Unterstützung, um zu skalieren.

---

> **Erfahre mehr über Openversum und unterstütze ihre Mission auf Dopaya**
> [https://dopaya.com/project/openversum](https://dopaya.com/project/openversum)
...
Impact Bites ist eine Kurzinterview-Reihe mit Sozialunternehmern, die echte Probleme lösen. Jede Episode umfasst: was sie tun, ihre Entstehungsgeschichte, was die meisten Menschen falsch verstehen (Mythen aufgedeckt), eine menschliche Wirkungsgeschichte und die 10-Dollar-Frage – was bewirkt eine kleine Spende wirklich? Nachhaltige Wirkung, einfach erklärt.

[Entdecke weitere Sozialunternehmen auf Dopaya](https://dopaya.com)`,
};
