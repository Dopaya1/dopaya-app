            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center relative">
              ...
              <div className="relative h-[380px] md:h-[460px]" style={{ zIndex: 2 }}>
                <div className="absolute left-2 top-6">
                  {bubbleProjects[0] && (
                    <div className="relative">
                      <img src={getProjectImageUrl(bubbleProjects[0]) || ''} alt={bubbleProjects[0].title} className="w-28 h-28 md:w-32 md:h-32 rounded-full object-cover ring-4 ring-orange-100" />
                ...
                <div className="absolute left-24 md:left-32 top-40">
                  {bubbleProjects[1] && (
                    <div className="relative">
                      <img src={getProjectImageUrl(bubbleProjects[1]) || ''} alt={bubbleProjects[1].title} className="w-24 h-24 md:w-28 md:h-28 rounded-full object-cover ring-4 ring-orange-100" />
                      <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 text-[11px] bg-white text-gray-800 px-2 py-0.5 rounded border border-gray-200 whitespace-nowrap">
                ...
                <div className="absolute left-0 bottom-4">
                  {bubbleProjects[2] && (
                    <div className="relative">
                      <img src={getProjectImageUrl(bubbleProjects[2]) || ''} alt={bubbleProjects[2].title} className="w-28 h-28 md:w-32 md:h-32 rounded-full object-cover ring-4 ring-orange-100" />
                      <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 text-[11px] bg-white text-gray-800 px-2 py-0.5 rounded border border-gray-200 whitespace-nowrap">
