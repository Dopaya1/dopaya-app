      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-6">
            <p>
              This Privacy Notice for Dopaya.com ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
            </p>
            
            <ul className="list-disc pl-6 space-y-2">
              <li>Visit our website at http://dopaya.com, or any website of ours that links to this Privacy Notice</li>
              <li>Engage with us in other related ways, including any sales, marketing, or events</li>
            </ul>
            
            <p>
              Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at hello@dopaya.com.
            </p>
            ...
            <p>
              Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: http://dopaya.com/cookies.
            </p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
            ...
            <p>
              Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: http://dopaya.com/cookies.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Google Analytics</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">8. DO WE COLLECT INFORMATION FROM MINORS?</h2>
            ...
            <p>
              We do not knowingly collect, solicit data from, or market to children under 18 years of age, nor do we knowingly sell such personal information. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent's use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at hello@dopaya.com.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Account Information</h3>
            ...
            <p>
              Cookies and similar technologies: Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: http://dopaya.com/cookies.
            </p>

            <p>
              If you have questions or comments about your privacy rights, you may email us at hello@dopaya.com.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>

            <p>
              In Short: If you are a resident of California, Colorado, Connecticut, Delaware, Florida, Indiana, Iowa, Kentucky, Montana, New Hampshire, New Jersey, Oregon, Tennessee, Texas, Utah, or Virginia, you may have the right to request access to and receive details about the personal information we maintain about you and how we have processed it, correct inaccuracies, get a copy of, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. More information is provided below.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Categories of Personal Information We Collect</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Sources of Personal Information</h3>

            <p>
              Learn more about the sources of personal information we collect in "WHAT INFORMATION DO WE COLLECT?"
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">How We Use and Share Personal Information</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">How to Exercise Your Rights</h3>

            <p>
              To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at hello@dopaya.com, or by referring to the contact details at the bottom of this document.
            </p>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Request Verification</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Appeals</h3>

            <p>
              Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at hello@dopaya.com. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">California "Shine The Light" Law</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">12. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>

            <p>
              If you have questions or comments about this notice, you may email us at hello@dopaya.com or contact us by post at:
            </p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-12 mb-6">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
